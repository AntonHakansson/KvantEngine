...
namespace Kvant {
    ...
    struct MayHaveDrawable<DRAWABLE, ME,
                           typename if_<false, typename DRAWABLE::TDrawable>::type> {
    ...
    struct MayHaveDrivable<DRIVABLE, ME,
                         typename if_<false, typename DRIVABLE::TDrivable>::type> {
    ...
    struct MayHaveTransformable <TRANSFORMABLE, ME,
