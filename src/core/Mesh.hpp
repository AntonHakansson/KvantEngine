...
static glm::vec3 triangle_tangent(Vertex vert1, Vertex vert2, Vertex vert3) {
  ...
  glm::vec3 tdir =
      glm::vec3((uv_space1.x * comp_vec2.x - uv_space2.x * comp_vec1.x) * r,
...
static glm::vec3 triangle_binormal(Vertex vert1, Vertex vert2, Vertex vert3) {
  ...
  glm::vec3 tdir =
      glm::vec3((uv_space1.y * comp_vec2.x - uv_space2.y * comp_vec1.x) * r,
...
static const int _hash(glm::vec2 v) { return abs(rawcast(v.x) ^ rawcast(v.y)); }
...
template <> struct hash<Kvant::Vertex> {
